...
public class FragmentMobileVerify extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview=inflater.inflate(R.layout.fragment_fragment_mobile_verify, container, false);
                ...
                if(city!=null)
                {
                    ...
                    if (etmobile.getText().toString().length() == 10)
                    {
                        ...
                        if (customer == null)
                        {
                            ...
                            Fragment fragment= com.example.genekatechnologies2.readvwlvet.Customer_Details.newInstance(etmobile.getText().toString(),city);
