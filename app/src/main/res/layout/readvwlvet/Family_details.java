...
public class Family_details extends Fragment {
    ...
    private Button next;
    private ArrayList<com.example.genekatechnologies2.readvwlvet.database.Family_Table> familylist= new ArrayList<com.example.genekatechnologies2.readvwlvet.database.Family_Table>();
    public Family_details() {
     }
    // TODO: Rename and change types and number of parameters
    public static com.example.genekatechnologies2.readvwlvet.Family_details newInstance(String mobile) {
        com.example.genekatechnologies2.readvwlvet.Family_details fragment = new com.example.genekatechnologies2.readvwlvet.Family_details();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnaddnew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment feedBack_details= com.example.genekatechnologies2.readvwlvet.FeedBack_Details.newInstance(mobileno,familylist);
            ...
            public void onClick(View v) {
                ...
                customer_dob.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        com.example.genekatechnologies2.readvwlvet.CustomCalender cal= new com.example.genekatechnologies2.readvwlvet.CustomCalender(getActivity()) {
                            @Override
                ...
                yes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        boolean result=true;
                        com.example.genekatechnologies2.readvwlvet.database.Family_Table person=new com.example.genekatechnologies2.readvwlvet.database.Family_Table();
                        ...
                        if(result)
                        {
                            ...
                            com.example.genekatechnologies2.readvwlvet.FamilyAdapter adapter=new com.example.genekatechnologies2.readvwlvet.FamilyAdapter(getActivity(),R.layout.rowfamily,familylist);
