...
import  nikam.com.demo_redvelvet.database.Customer_FeedBack;
import  nikam.com.demo_redvelvet.database.Family_Table;
import  nikam.com.demo_redvelvet.database.Family_Table_Helper;
import  nikam.com.demo_redvelvet.database.FeedBackHelper;
...
public class FeedBack_Details extends Fragment
{
    ...
    public static FeedBack_Details newInstance(String mobile,  ArrayList<Family_Table> param2) {
        FeedBack_Details fragment = new FeedBack_Details();
        Bundle args = new Bundle();
        FeedBack_Details.familylist=param2;
            ...
            public void onClick(View v) {
                ...
                if(FeedBackHelper.inserFeedBack(getActivity(),feedback))
                {
                    for (Family_Table family:familylist)
                    {
                        ...
                        Family_Table_Helper.inserFamily(getActivity(),family);
                    }
