...
public class SyncFeedBack {
    ...
    public static Boolean uploadFeedBack(final Activity activity, final Customer_FeedBack feddback)
    {
            ...
            public void onResponse(String response) {
                try
                {
                    ...
                    if(message.equalsIgnoreCase("1"))
                    {
                        ...
                        FeedBackHelper.updateFeedBack(activity,feddback);
                    }
                    else
                    {
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError
            {
             ...
             //   params.put("", String.valueOf(feddback.));
                Customer_Table_Helper.getCustomerdata(activity,feddback.getCust_id_value());
                params.put("","");
                Family_Table_Helper.getFamilyList(activity, String.valueOf(feddback.getFeedback_Id_Value()));
                params.put("","");
